...
const headingWords = ["Instantly", "See", "Your", "Potential", "Savings"];
              ...
              <div className="w-full flex flex-col items-center px-5 sm:px-[32px] py-[50px]">
                ...
                <div className="max-w-[520px] text-center">
                  ...
                  <p className="mt-[12px] text-[#73797B] text-[15px] leading-[170%]">
                    Our HIPAA-compliant engine is cross-referencing your billing
                    data against institutional benchmarks and recovery
                    protocols.
                  </p>
                </div>
